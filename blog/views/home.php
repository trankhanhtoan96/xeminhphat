<?php include APPPATH . 'views/header.php'; ?>
    <div class="container hidden-xs">
        ...
        <table class="table table-bordered" style="font-weight: bold;text-align: center;color:#CB2134">
            ...
            <tr>
                <td>22 Âm Lịch</td>
                <td>10h00 - 14h00 - 17h00</td>
                <td>700.000 đồng</td>
            </tr>
            <tr>
                <td>24 & 29 Âm Lịch</td>
                <td>8h00 - 10h00 - 14h00 - 16h00 - 19h00</td>
                <td>800.000 đồng</td>
            </tr>
            <tr>
        ...
        <table class="table table-bordered" style="font-weight: bold;text-align: center;color:#CB2134">
            ...
            <tr>
                <td>10 Âm Lịch</td>
                <td>10h00 - 12h00 - 14h00 - 16h00 - 18h00</td>
                <td>800.000 đồng</td>
            </tr>
            <tr>
        ...
        <ol style="font-size: 20px;color:#102E6A;font-weight: bold">
            ...
            <li>THÁI ĐỘ PHỤC VỤ - ÂN CẦN - THÂN THIỆN - LỊCH THIỆP - CHUYÊN NGHIỆP</li>
            <li>CHỞ ĐÚNG QUY ĐỊNH - KHÔNG NHỒI NHÉT KHÁCH</li>
            <li>KHÔNG PHỤC VỤ VỚI THÁI ĐỘ BẤT CẦN KHÁCH</li>
            <li>XE CHẠY AN TOÀN ĐÚNG TỐC ĐỘ QUY ĐỊNH</li>
    ...
    <div class="container hidden-sm hidden-md hidden-lg">
        ...
        <table class="table table-bordered" style="font-weight: bold;text-align: center;color:#CB2134">
            ...
            <tr>
                ...
                <td nowrap>10h00 - 14h00 - 17h00</td>
